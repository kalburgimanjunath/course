...
function ($, ko) {
    ...
    /*
        google Autocomplete feature (search by City only)
    */
        ...
        init: function (element, valueAccessor, allBindings, viewModel, bindingContext) {
            ...
            if (options && typeof (options.onComplete) === 'function') {
                var context = ko.contextFor(element);
                    ...
                    googleAutocomplete_Address($(element), function (data) {
                    // googleAutocomplete_old('modal-id-customer', 'city', function (data) {
                    options.onComplete.call(context.$data, data);
                });
            }
        }
    };
